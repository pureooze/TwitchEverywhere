...
public class MsgBenchmark {
    ...
    public async Task PrivMsg() {
        ...
        const string baseMessage = "@badge-info=;badges=turbo/1;color=#0D4200;display-name=ronni;emotes=25:0-4,12-16/1902:6-10;id=b34ccfc7-4977-403a-8a94-33c6bac34fb8;mod=0;room-id=1337;subscriber=0;tmi-sent-ts=1507246572675;turbo=1;user-id=1337;user-type=global_mod :ronni!ronni@ronni.tmi.twitch.tv PRIVMSG #channel :";
    ...
    public async Task ClearMsg() {
        ...
        const string baseMessage = $"@login=ronni;room-id=;target-msg-id=abc-123-def;tmi-sent-ts=1507246572675 :tmi.twitch.tv CLEARMSG #channel :";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task ClearChat() {
        ...
        const string baseMessage = $"@ban-duration=350;room-id=12345678;target-user-id=87654321;tmi-sent-ts=1507246572675 :tmi.twitch.tv CLEARCHAT #channel :";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task NoticeMsg() {
        ...
        const string baseMessage = $"@msg-id=whisper_restricted;target-user-id=12345678 :tmi.twitch.tv NOTICE #channel :";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task GlobalUserStateMessage() {
        ...
        const string baseMessage = $"@badge-info=subscriber/8;badges=subscriber/6;color=#0D4200;display-name=dallas;emote-sets=0,33,50,237,793,2126,3517,4578,5569,9400,10337,12239;turbo=0;user-id=12345678;user-type=admin :tmi.twitch.tv GLOBALUSERSTATE";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task WhisperMessage() {
        ...
        const string baseMessage = $"@badges=staff/1,bits-charity/1;color=#8A2BE2;display-name=PetsgomOO;emotes=;message-id=306;thread-id=12345678_87654321;turbo=0;user-id=87654321;user-type=staff :petsgomoo!petsgomoo@petsgomoo.tmi.twitch.tv WHISPER foo :hello";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task RoomStateMessage() {
        ...
        const string baseMessage = $"@emote-only=0;followers-only=0;r9k=0;slow=0;subs-only=0 :tmi.twitch.tv ROOMSTATE #channel";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task JoinMsg() {
        ...
        const string baseMessage = $":ronni!ronni@ronni.tmi.twitch.tv JOIN #channel";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
    ...
    public async Task PartMsg() {
        ...
        const string baseMessage = $":ronni!ronni@ronni.tmi.twitch.tv PART #channel";
        IWebSocketConnection webSocket = new TestWebSocketConnection( iterations: Iterations, baseMessage: baseMessage );
        IMessageProcessor messageProcessor = new MessageProcessor( dateTimeService: dateTimeService.Object );
