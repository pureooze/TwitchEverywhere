...
[TestFixture]
public class GetUsersByLoginTests {
    ...
    [Test]
    public async Task NoUsersProvided_GetUsersByLogin_NoResults() {
        // Arrange
        ...
        // Act
        GetUsersResponse result = await usersApiService.GetUsersByLogin( 
            m_httpClient.Object, 
            Array.Empty<string>() 
        );
    ...
    [Test]
    public async Task UserProvided_GetUsersByLogin_ResultForUser() {
        // Arrange
        m_httpClient.Setup( hc => 
            hc.SendAsync( 
                It.IsAny<HttpRequestMessage>(), 
    ...
    [Test]
    public async Task MultipleUsersProvided_GetUsersByLogin_ResultForUsers() {
        // Arrange
        m_httpClient.Setup( hc => 
            hc.SendAsync( 
                It.IsAny<HttpRequestMessage>(), 
