...
[TestFixture]
public class UserStateMsgTests {
    ...
    public async Task UserStateMsg( IImmutableList<string> messages, UserStateMsg expectedMessage ) {
        ...
        void MessageCallback(
            ...
            UserStateMsg msg = (UserStateMsg)message;
    ...
    private void UserStateMsgMessageCallback(
        UserStateMsg message,
        UserStateMsg? expectedMessage
    ) {
        Assert.Multiple(() => {
