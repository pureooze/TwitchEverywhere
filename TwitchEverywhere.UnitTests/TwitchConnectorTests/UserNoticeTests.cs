...
public class UserNoticeTests {
    ...
    public async Task UserNotice( IImmutableList<string> messages, UserNotice expectedMessage ) {
        ...
        void MessageCallback(
            ...
            UserNotice msg = (UserNotice)message;
    ...
    private void UserNoticeMessageCallback(
        UserNotice clearChat,
        UserNotice? expectedClearChatMessage
    ) {
        Assert.Multiple(() => {
