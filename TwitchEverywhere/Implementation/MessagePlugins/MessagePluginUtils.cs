...
internal static class MessagePluginUtils {
    ...
    public readonly static Regex MsgParamCumulativeMonthsPattern = new(@"msg-param-cumulative-months=([^;]*);");
    public readonly static Regex MsgParamDisplayNamePattern = new(@"msg-param-displayName=([^;]*);");
    public readonly static Regex MsgParamGiftMonthsPattern = new(@"msg-param-gift-months=([^;]*);");
    public readonly static Regex MsgParamLoginPattern = new(@"msg-param-login=([^;]*);");
    public readonly static Regex MsgParamMonthsPattern = new(@"msg-param-months=([^;]*);");
    public readonly static Regex MsgParamPromoGiftTotalPattern = new(@"msg-param-promo-gift-total=([^;]*);");
    public readonly static Regex MsgParamPromoNamePattern = new(@"msg-param-promo-name=([^;]*);");
    public readonly static Regex MsgParamRecipientDisplayNamePattern = new(@"msg-param-recipient-display-name=([^;]*);");
    public readonly static Regex MsgParamRecipientIdPattern = new(@"msg-param-recipient-id=([^;]*);");
    public readonly static Regex MsgParamRecipientUserNamePattern = new(@"msg-param-recipient-user-name=([^;]*);");
    public readonly static Regex MsgParamRitualNamePattern = new(@"msg-param-ritual-name=([^;]*);");
    public readonly static Regex MsgParamSenderLoginPattern = new(@"msg-param-sender-login=([^;]*);");
    public readonly static Regex MsgParamSenderNamePattern = new(@"msg-param-sender-name=([^;]*);");
    public readonly static Regex MsgParamShouldShareStreakPattern = new(@"msg-param-should-share-streak=([^;]*);");
    public readonly static Regex MsgParamStreakMonthsPattern = new(@"msg-param-streak-months=([^;]*);");
    public readonly static Regex MsgParamSubPlanNamePattern = new(@"msg-param-sub-plan-name=([^;]*);");
    public readonly static Regex MsgParamSubPlanPattern = new(@"msg-param-sub-plan=([^;]*);");
    public readonly static Regex MsgParamThresholdPattern = new(@"msg-param-threshold=([^;]*);");
    public readonly static Regex MsgParamViewerCountPattern = new(@"msg-param-viewerCount=([^;]*);");
    ...
    public readonly static Regex SystemMessagePattern = new("system-msg([^ ;]*)");
